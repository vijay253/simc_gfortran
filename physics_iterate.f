...
c Variables calculated in transformation to gamma-NUCLEON center of mass.
        ...
        real*8 pm2_tmp
	real*8 s_fer,sig_blok,t_old,thetacm_fer,phicm_fer,davejac_fer
...
c	   sigtt=(((fitpar(12)*exp(fitpar(13)*abs(t_gev))+fitpar(14))/Q2_g*exp(-Q2_g))*ft*sin(thetacm)**2)
	   sigtt=((fitpar(12)/abs(t_gev)**3*exp(fitpar(13)*abs(t_gev))+fitpar(14)/abs(t_gev)**1)*sin(thetacm)**2)
c	   sigtt =0	   
c       print*,"sigtt", sigtt

c	   tav=(-0.178+0.315*log(Q2_g))*Q2_g
